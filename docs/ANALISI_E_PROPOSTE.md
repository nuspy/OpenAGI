...
| M31 | Nodi esogeni: direttive umane e fatti (imposti/opportunità) con peso, CRUD e rivalutazione | P0 | utente (rev. 5) | REQUISITO — implementato (Fase 9) | codice, PHASE9 |
| M32 | Interazione estesa: change-set nei thread, thread di scenario, consultazioni AI-initiated | P0 | utente (rev. 5) | REQUISITO — implementato (Fase 9) | codice, PHASE9 |
| M33 | Settings GUI strutturati (review matrix, grounding, esogeni) | P1 | utente (rev. 5) | REQUISITO — implementato (Fase 9) | codice |
